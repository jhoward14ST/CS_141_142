/**
 * Preliminary Test of CS 142 Assignment 4 by Martin Hock (Version of 3:00 PM
 * 11/3/2019)
 * 
 * You may only use this code as a student of Martin Hock, CS 142 Fall 2019.
 */
		...
		try {
			...
			for (int i = 0; i < lines.length; i++) {
				try {
						...
						try {
							...
							for (int j = 0; j < outs[i].length; j++) {
								...
								while (currentLine.hasNext()) {
									...
									if (myLine == null) myLine = myout;
									else myLine += " "+myout;
									String currentWord = currentLine.next();
									if (cLine == null) cLine = currentWord;
									else cLine += " "+currentWord;
									if (!currentWord.equals(myout)) {
										System.out.println("Line " + (j + 1) + ": expected a line beginning \"" + cLine+"\""); 
										System.out.println("but your code outputs a line beginning this way: \""+ myLine + "\"");
										break lineloop;
									}
								}
								if (j == 0) {
					...
					System.out.println("The following error in your code occurred while testing promptNumberReadLine, continuing to next case");
				...
				try {
					...
					if (!Arrays.equals(bcopy, board)) {
						...
						if (strs[i].equals(str.trim())) {
							...
							System.out.println("When calling createBoard("+pieces[i]+", "+middles[i]+"), your returned string from boardToString() should look like this:");
					...
					System.out.println("The following error in your code occurred while testing createBoard and boardToString, continuing to next case");
					e.printStackTrace(System.out);
					exCount++;
				}
			}
			...
			int[][] allowedMoves = {{2, 8, 4}, {4, 16, 8, 32, 16}, {4,32,10,64}, {4, 32, 10, 16, 2, 72, 4, 64, 32, 16, 8}, {8,256,20,640,36,1152,4,128,74,288,138,544,266,32,522,80,2,128}};
			String[][] amBoards = {{".CG", "GC.", "G.C"}, {"C.CGG", "CGC.G", "CG.CG", "CGGC.", "CGG.C"},{"C.C.GG","C.CG.G",".CCG.G",".CCGG."},{"C.C.GG","C.CG.G","C..GCG","C.G.CG",".CG.CG","GC..CG","G.C.CG","G.CGC.","G.CG.C","GGC..C","GG.C.C"},
					{"CC.C...GGG", "CC.C..G.GG", "CC..C.G.GG", "CC..C.GG.G", "CC...CGG.G", "CC...CGGG.", "C.C..CGGG.", "C.C.GC.GG.", "C.C.G.CGG.", "C.C.GGC.G.", "C.C.GG.CG.", "C.C.GGGC..", "C.C.GGG.C.", "C.CG.GG.C.", "C.CG.GG..C","C.CGG.G..C", ".CCGG.G..C", ".CCGGG...C"}};
			String[][] mainlines = {{"Please enter the number of pieces for each player (1-10): ",
				"Please enter the number of spaces in the middle (1-9): ",
				"C.G"+System.lineSeparator(),
				"Crickets, please enter your move (1-3): ",
				".CG"+System.lineSeparator(),
				"Grasshoppers, please enter your move (1-3): ",
				"GC."+System.lineSeparator(),
				"Crickets, please enter your move (1-3): ",
				"Crickets win!"+System.lineSeparator()},
					{
					"Please enter the number of pieces for each player (1-10): ", 
					"Please enter the number of spaces in the middle (1-9): ", 
					"CC.GG"+System.lineSeparator(), 
					"Crickets, please enter your move (1-5): ", 
					"C.CGG"+System.lineSeparator(), 
					"Grasshoppers, please enter your move (1-5): ", 
					"CGC.G"+System.lineSeparator(), 
					"Crickets, please enter your move (1-5): ", 
					"CG.CG"+System.lineSeparator(), 
					"Grasshoppers, please enter your move (1-5): ", 
					"CGGC."+System.lineSeparator(), 
					"Crickets, please enter your move (1-5): ", 
					"Crickets win!"+System.lineSeparator(), 
					},
					{"Please enter the number of pieces for each player (1-10): ", 
							"Please enter the number of spaces in the middle (1-9): ", 
							"CC..GG"+System.lineSeparator(), 
							"Crickets, please enter your move (1-6): ", 
							"C.C.GG"+System.lineSeparator(), 
							"Grasshoppers, please enter your move (1-6): ", 
							"C.CG.G"+System.lineSeparator(), 
							"Crickets, please enter your move (1-6): ", 
							".CCG.G"+System.lineSeparator(), 
							"Grasshoppers, please enter your move (1-6): ", 
					...
					{"Please enter the number of pieces for each player (1-10): ", 
								...
								"C.CG.G"+System.lineSeparator(), 
								"Crickets, please enter your move (1-6): ",
								"C..GCG"+System.lineSeparator(), 
								"Grasshoppers, please enter your move (1-6): ",
								"C.G.CG"+System.lineSeparator(),
								"Crickets, please enter your move (1-6): ",
								".CG.CG"+System.lineSeparator(), 
								"Grasshoppers, please enter your move (1-6): ",
								"GC..CG"+System.lineSeparator(), 
								"Crickets, please enter your move (1-6): ",
								"G.C.CG"+System.lineSeparator(), 
								"Grasshoppers, please enter your move (1-6): ",
								"G.CGC."+System.lineSeparator(), 
								"Crickets, please enter your move (1-6): ",
								"G.CG.C"+System.lineSeparator(), 
								"Grasshoppers, please enter your move (1-6): ",
								"GGC..C"+System.lineSeparator(), 
								"Crickets, please enter your move (1-6): ",
								"Crickets win!"+System.lineSeparator()
					},
					{"Please enter the number of pieces for each player (1-10): " + 
							"Please enter the number of spaces in the middle (1-9): " + 
							"CCC....GGG"+System.lineSeparator(), 
							"Crickets, please enter your move (1-10): " + 
							"CC.C...GGG"+System.lineSeparator(), 
							"Grasshoppers, please enter your move (1-10): " + 
							"CC.C..G.GG"+System.lineSeparator(), 
							"Crickets, please enter your move (1-10): " + 
							"CC..C.G.GG"+System.lineSeparator(), 
							"Grasshoppers, please enter your move (1-10): " + 
							"CC..C.GG.G"+System.lineSeparator(), 
							"Crickets, please enter your move (1-10): " + 
							"CC...CGG.G"+System.lineSeparator(), 
							"Grasshoppers, please enter your move (1-10): " + 
							"CC...CGGG."+System.lineSeparator(), 
							"Crickets, please enter your move (1-10): " + 
							"C.C..CGGG."+System.lineSeparator(), 
							"Grasshoppers, please enter your move (1-10): " + 
							"C.C.GC.GG."+System.lineSeparator(), 
							"Crickets, please enter your move (1-10): " + 
							"C.C.G.CGG."+System.lineSeparator(), 
							"Grasshoppers, please enter your move (1-10): " + 
							"C.C.GGC.G."+System.lineSeparator(), 
							"Crickets, please enter your move (1-10): " + 
							"C.C.GG.CG."+System.lineSeparator(), 
							"Grasshoppers, please enter your move (1-10): " + 
							"C.C.GGGC.."+System.lineSeparator(), 
							"Crickets, please enter your move (1-10): " + 
							"C.C.GGG.C."+System.lineSeparator(), 
							"Grasshoppers, please enter your move (1-10): " + 
							"C.CG.GG.C."+System.lineSeparator(), 
							"Crickets, please enter your move (1-10): " + 
							"C.CG.GG..C"+System.lineSeparator(),
							"Grasshoppers, please enter your move (1-10): " + 
							"C.CGG.G..C"+System.lineSeparator(), 
							"Crickets, please enter your move (1-10): " + 
							".CCGG.G..C"+System.lineSeparator(), 
							"Grasshoppers, please enter your move (1-10): " + 
							"Grasshoppers win!"+System.lineSeparator() }
			};
				...
				try {
					...
					for (int j = 0; j < allowedMoves[i].length; j++) {
						...
						for (int k = 0; k <= board.length+2; k++) {
							if (((1<<k)&allowedMoves[i][j])!=0) continue;
							try {
								if (k == 0) {
									if (!CricketsAndGrasshoppers.canMove(board, 1+(j&1))) {
										System.out.println("canMove("+Arrays.toString(bcopy)+", "+(1+(j&1))+") reports that a move can't be made, but you can!");
										System.out.println("move("+Arrays.toString(bcopy)+", "+(1+(j&1))+", "+bb(allowedMoves[i][j], strats[i], 1+(j&1))+") is possible.");
										ok = false;
										break;
									} else if (!Arrays.equals(board, bcopy)) {
										System.out.println("canMove("+Arrays.toString(bcopy)+", "+(1+(j&1))+") modified the board!");
								...
								if (k == board.length+2) {
									if (!CricketsAndGrasshoppers.move(board, 1+(j&1), bb(allowedMoves[i][j], strats[i], 1+(j&1)))) {
										System.out.println("move("+Arrays.toString(bcopy)+", "+(1+(j&1))+", "+bb(allowedMoves[i][j], strats[i], 1+(j&1))+") returned false but move should be allowed!");
										ok = false;
									} else if (Arrays.equals(board, bcopy)) {
										System.out.println("move("+Arrays.toString(bcopy)+", "+(1+(j&1))+", "+bb(allowedMoves[i][j], strats[i], 1+(j&1))+") returned true but didn't change the board!");
										ok = false;
									} else if (!amBoards[i][j].equals(CricketsAndGrasshoppers.boardToString(board).trim())) {
										System.out.println("move("+Arrays.toString(bcopy)+", "+(1+(j&1))+", "+bb(allowedMoves[i][j], strats[i], 1+(j&1))+") returned true but changed the board incorrectly!");
										System.out.println("Should look like: "+amBoards[i][j]);
										System.out.println("Yours looks like: "+CricketsAndGrasshoppers.boardToString(board).trim());
										ok = false;
									} else {
										goodTMoveCount++;
										goodBoardCount++;
									...
									if (CricketsAndGrasshoppers.move(board, 1+(j&1), k)) {
										System.out.println("move("+Arrays.toString(bcopy)+", "+(1+(j&1))+", "+k+") returned true but move should not be allowed!");
										if (Arrays.equals(board, bcopy)) {
											System.out.println("The board didn't change, however.");
										} else {
											System.out.println("After the move, the array looks like: "+Arrays.toString(board));
											board = bcopy.clone();
										}
										ok = false;
										continue;
									...
									if (!Arrays.equals(board, bcopy)) {
										System.out.println("move("+Arrays.toString(bcopy)+", 1, "+i+") returned false but board changed!");
										System.out.println("After the move, the array looks like: "+Arrays.toString(board));
										board = bcopy.clone();
										ok = false;
										continue;
								...
								System.out.println("When calling canMove or move("+Arrays.toString(bcopy)+", "+(1+(j&1))+", "+(k<board.length+2?k:bb(allowedMoves[i][j], strats[i], 1+(j&1)))+") the following exception occurred in your code:");
								e.printStackTrace(System.out);
								exCount++;
								if (!Arrays.equals(board, bcopy)) {
					...
					if (CricketsAndGrasshoppers.canMove(board, 1+(allowedMoves[i].length&1))) {
						System.out.println("canMove("+Arrays.toString(bcopy)+", "+(1+(allowedMoves[i].length&1))+") reports that a move can be made, but you can't!");
						ok = false;
					} else if (!Arrays.equals(bcopy, board)) {
						System.out.println("canMove("+Arrays.toString(bcopy)+", "+(1+(allowedMoves[i].length&1))+") changed the board!");
						System.out.println("It should only check if a move can be made, not change anything.");
						ok = false;
					} else {
						cmScore++;
			...
			try {
				for (int i = 0; i < allowedMoves.length; i++) {
					System.out.println("Testing main method on a run with "+mpieces[i]+" pieces per player and "+mmiddles[i]+" in the middle: ");
					...
					Scanner outReader = null;
					try {
						if (bos.toString().replaceAll("\\s*", "").equalsIgnoreCase(String.join("", mainlines[i]).replaceAll("\\s*", ""))) {
							...
							for (int j = 0; j < mainlines[i].length; j++) {
								if (!outReader.hasNextLine()) {
									System.out.println("Should have " + mainlines[i].length + " lines of output but only has " + j);
									break;
								}
			...
			if (exCount > 0) {
				total--;
				System.out.println("1 point penalty for the "+exCount+" exception"+(exCount>1?"s":"")+" mentioned above.");
			}
			if (total == 101 && idCount == 10 && exCount == 0) total++;
			if (total <= 100) {
				System.out.println("If you earn all the above points, you'll earn an extra credit point (101 / 100)!");
			} else if (total == 101) {
				System.out.println("To get one more extra credit point, make sure your output is identical to what is expected.");
				System.out.println("Understand the use of print versus println, and include correct spacing and capitalization.");
			} else if (total == 102) {
